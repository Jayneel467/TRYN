...
export const siteConfig = {
  ...
  description:
    "TRYN Studios is a product engineering studio and venture partner. We build AI products, SaaS platforms, and dedicated engineering teams for founders and growth-stage companies.",
  url: env.siteUrl ?? "https://tryn.studio",
